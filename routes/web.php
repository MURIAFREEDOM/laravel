...
Route::controller(NotifikasiController::class)->group(function() {
    Route::get('/semua_notif','index')->middleware('verify');
    Route::post('/kirim_pesan','sendMessage');
});
...
Route::controller(LoginController::class)->group(function() {
    ...
    Route::post('/login/kandidat','login');
    Route::post('/login/akademi','login');
    Route::post('/login/perusahaan','login');
