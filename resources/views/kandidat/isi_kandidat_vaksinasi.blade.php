                                ...
                                <div class="row mb-3 g-3 align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @elseif ($kandidat->sertifikat_vaksin1 !== null)
                                            <img src="/gambar/Kandidat/{{$kandidat->nama}}/Vaksin Pertama/{{$kandidat->sertifikat_vaksin1}}" class="img" width="150" height="150" alt="">
                                ...
                                <div class="row mb-3 g-3 align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @elseif ($kandidat->sertifikat_vaksin2 !== null)
                                            <img src="/gambar/Kandidat/{{$kandidat->nama}}/Vaksin Kedua/{{$kandidat->sertifikat_vaksin2}}" class="img" width="150" height="150" alt="">
                                ...
                                <div class="row mb-3 g-3 align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @elseif ($kandidat->sertifikat_vaksin3 !== null)
                                            <img src="/gambar/Kandidat/{{$kandidat->nama}}/Vaksin Ketiga/{{$kandidat->sertifikat_vaksin3}}" class="img" width="150" height="150" alt="">
                                            <input type="file" name="sertifikat_vaksin3" class="form-control" accept="image/*">                                            
                                        @else
                                            <input type="file" name="sertifikat_vaksin3" class="form-control" accept="image/*">                                            
                                        @endif
