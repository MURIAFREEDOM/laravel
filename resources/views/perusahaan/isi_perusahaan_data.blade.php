                ...
                <div class="row">
                    ...
                    <form action="/perusahaan/isi_perusahaan_data" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="" id="perusahaan_biodata">
                            ...
                            <div class="row mb-3 g-3 align-items-center">
                                <div class="col-md-4">
                                    <label for="inputPassword6" class="col-form-label">Email Perusahaan</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="email" required value="{{$perusahaan->email_perusahaan}}" name="email_perusahaan" id="inputPassword6" class="form-control" aria-labelledby="passwordHelpInline">
                                </div>
                            </div>
                            <div class="row mb-3 g-3 align-items-center">
                                <div class="col-md-4">
                                    <label for="inputPassword6" class="col-form-label">No Telp Perusahaan</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="number" required value="{{$perusahaan->no_telp_perusahaan}}" name="no_telp_perusahaan" id="inputPassword6" class="form-control" aria-labelledby="passwordHelpInline">
                                </div>
                            </div>
                            <div class="row mb-3 g-3 align-items-center">
                                <div class="col-md-4">
