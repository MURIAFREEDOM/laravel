...
class KandidatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kandidat/index',compact('kandidat','notif','perusahaan','pembayaran'));
        }
    }
    ...
    public function simpan_kandidat_company(Request $request)
    {
        ...
        if(PengalamanKerja::where('id_kandidat',$kandidat->id_kandidat) == null){
    ...
    public function contactUsKandidat()
    {
        ...
        $notif = Notification::where('id_kandidat',$kandidat->id_kandidat)->get();
        $pembayaran = Pembayaran::where('id_kandidat',$kandidat->id_kandidat)->first();
        return view('kandidat/contact_us',compact('kandidat','notif','pembayaran'));
    }
    ...
    public function sendContactUsKandidat(Request $request)
    {
        ...
        return redirect('/kandidat')->with('toast_warning','Pesan anda sudah terkirim, mohon tunggu pesan dari admin');
    }
    ...
    public function Perusahaan($id)
    {
        ...
        $notif = Notification::where('id_kandidat',$kandidat->id_kandidat)->get();
        $pembayaran = Pembayaran::where('id_kandidat',$kandidat->id_kandidat)->first();
        return view('kandidat/profil_perusahaan',compact('kandidat','perusahaan','notif','pembayaran'));
    }
}
